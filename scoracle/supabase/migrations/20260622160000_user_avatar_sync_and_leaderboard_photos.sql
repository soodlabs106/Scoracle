...
create function public.get_overall_leaderboard()
returns table (
  user_id uuid,
  username text,
  favorite_club text,
...
drop function if exists public.get_match_week_leaderboard(integer);
create function public.get_match_week_leaderboard(selected_match_week integer)
returns table (
  user_id uuid,
  username text,
  favorite_club text,
...
drop function if exists public.get_match_week_rank_movement(integer);
create function public.get_match_week_rank_movement(selected_match_week integer)
returns table (
  user_id uuid,
  username text,
  favorite_club text,
